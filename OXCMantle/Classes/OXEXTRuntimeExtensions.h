...
typedef enum {
     ...
     */
    OX_mtl_propertyMemoryManagementPolicyAssign = 0,
    
    /**
     * The value is retained.
     */
    OX_mtl_propertyMemoryManagementPolicyRetain,
    
    /**
     * The value is copied.
     */
    OX_mtl_propertyMemoryManagementPolicyCopy
} OX_mtl_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     */
    OX_mtl_propertyMemoryManagementPolicy memoryManagementPolicy;
