...
OX_mtl_propertyAttributes *mtl_copyPropertyAttributes (objc_property_t property) {
    ...
    OX_mtl_propertyAttributes *attributes = calloc(1, sizeof(OX_mtl_propertyAttributes) + typeLength + 1);
    if (!attributes) {
    ...
    while (next && *next == ',') {
        ...
        switch (flag) {
            ...
            case 'C':
                attributes->memoryManagementPolicy = OX_mtl_propertyMemoryManagementPolicyCopy;
                break;
                
            case '&':
                attributes->memoryManagementPolicy = OX_mtl_propertyMemoryManagementPolicyRetain;
                break;
